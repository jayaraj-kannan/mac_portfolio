...
const userDetails = {
    ...
    experience: [
        {
            ...
            skill: ['Enovia','R24x','R13x', '3DExperience Cloud', 'Iterop', 'google cloud', 'github', 'CI/CD', 'widgets', 'vue.js', 'spring boot','J2EE','Java', 'REST Api','JSP','JPO','MQL','TCL']
        },
        {
    ...
    projects: [
        {
            title: 'AI Reference sheet Generator for Artists',
            key: 'toon_ref',
            icon: 'mdi mdi-web',
            cover: new URL(`../assets/images/toonref_cover.png`, import.meta.url).href,
            blog: `https://medium.com/@jrajfx/deconstructing-art-styles-how-i-built-a-practice-guide-style-sheet-generator-with-gemini-3-pro-and-29b57510cb79`,
            description: `The Artist’s Dilemma: Generic Tutorials vs. Specific Practice Like many hobbyists, I love to draw. I’m constantly chasing the next style — whether it’s the sleek lines of modern digital sketching, the vibrant colors of anime characters, or the subtle textures of classic illustration.
The biggest roadblock? The learning curve.Starting a new style often means hours of passive consumption: watching tutorials that cover the basics but rarely address the specifics of the one image I want to emulate. I’d stare at a reference image and struggle to decode the artist’s choices: What is the line weight? Is that cell shading or soft blending? What’s the hidden color in the shadows?
I realized what I needed wasn’t another tutorial, but an instant, personalized Style Sheet — a technical breakdown of my reference image that was ready for practice. That’s when the idea to use Generative AI hit me.`,
            tech: [`React.js`, `Gemini 3 pro`, 'vite']
        },
        {
    ...
    liveWallpapers: [
        'https://cdn.coverr.co/videos/coverr-abstract-fluid-flow-4375/1080p.mp4',
        'https://cdn.coverr.co/videos/coverr-liquid-background-4413/1080p.mp4',
        'https://cdn.coverr.co/videos/coverr-wavy-lines-7728/1080p.mp4'
    ]
}
export function actualYrsOfExp(){
...
export const aboutMeText = `${userDetails.personal.welcome} ${userDetails.personal.description}`;
